        ...
        return `
            <div class="activity-container">
                ...
                <div class="content-scrollable" style="padding: 10px;">
                    ...
                    <div class="instruction-section" style="display:none;"> <!-- Hidden in XML -->
                        <div class="instruction-title">INITIAL SETUP</div>
                        <div class="instruction-content">
                            Under SET INPUT STYLE choose Input Style 3. This is the only style you will ever need and once set should never need to be changed.
                        </div>
                    </div>
                    ...
                    <div class="instruction-section">
                        ...
                        <div class="instruction-content">
                            Here is a very brief operational guide to get you started.<br><br>From the main title page tap Perform.<br><br>Your phone should look like your real Home Screen. But within the app buttons are some hidden secrets.
                        </div>
                    </div>

                    <img src="assets/images/ic_launcher.png" style="width: 100%; max-width: 300px; display: block; margin: 20px auto;" /> 
                    <!-- Replaced mipmap/apphome with generic launcher or similar if apphome not found, using ic_launcher as placeholder or check assets -->
